...
export const copy = {
  ...
  startHint: {
    fr: "Choisis Upper A, Lower A, Upper B ou Lower B. Tes séries sont enregistrées.",
    en: "Pick Upper A, Lower A, Upper B, or Lower B. Your sets are saved.",
    zh: "选上肢 A、下肢 A、上肢 B 或下肢 B。组数会保存下来。",
    py: "xuǎn shàng zhī A, xià zhī A, shàng zhī B huò xià zhī B. zǔ shù huì bǎo cún xià lái.",
  },
  sessionsToday: {
  ...
  analyzing: {
    fr: "Lecture de ta séance…",
    en: "Reading your session…",
    zh: "正在看你的训练…",
    py: "zhèng zài kàn nǐ de xùn liàn",
  },
  retryAnalysis: {
